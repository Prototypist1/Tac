...
namespace Tac.Frontend.TypeProblem.Test
{
    ...
    public class TestTpn
    {
        ...
        public void AddType()
        {
            ...
            x.CreateMember(hello, new NameKey("x"),true, new WeakMemberDefinitionConverter(false, new NameKey("x")));
            x.CreateMember(hello, new NameKey("y"), true, new WeakMemberDefinitionConverter(false, new NameKey("y")));
        ...
        public void AddMethod()
        {
            ...
            var method_x = x.CreateMember(method, new NameKey("x"), true, new WeakMemberDefinitionConverter(false, new NameKey("x")));
            var method_y = x.CreateMember(method, new NameKey("y"), true, new WeakMemberDefinitionConverter(false, new NameKey("y")));
        ...
        public void AssignmentXDownStream()
        {
            ...
            var m1 = x.CreateMember(x.ModuleRoot, new NameKey("m1"), true, new WeakMemberDefinitionConverter(false, new NameKey("m1")));
            x.CreateHopefulMember(m1, new NameKey("x"), new WeakMemberDefinitionConverter(false, new NameKey("x")));
            var m2 = x.CreateMember(x.ModuleRoot, new NameKey("m2"), true, new WeakMemberDefinitionConverter(false, new NameKey("m2")));
            x.CreateHopefulMember(m2, new NameKey("y"), new WeakMemberDefinitionConverter(false, new NameKey("y")));
            var m3 = x.CreateMember(x.ModuleRoot, new NameKey("m3"), true, new WeakMemberDefinitionConverter(false, new NameKey("m3")));
            var m4 = x.CreateMember(x.ModuleRoot, new NameKey("m4"), true, new WeakMemberDefinitionConverter(false, new NameKey("m4")));
            var m5 = x.CreateMember(x.ModuleRoot, new NameKey("m5"), true, new WeakMemberDefinitionConverter(false, new NameKey("m5")));
        ...
        public void Generic()
        {
            ...
            x.CreateMember(pairType, new NameKey("x"),
                OrType.Make<IKey, IError>(new NameKey("T")), true, new WeakMemberDefinitionConverter(false, new NameKey("x")));
            ...
            x.CreateMember(chickenType, new NameKey("eggs"), true, new WeakMemberDefinitionConverter(false, new NameKey("eggs")));

            var chickenPair = x.CreateMember(x.ModuleRoot, new NameKey("x"),  OrType.Make<IKey, IError>(new GenericNameKey(new NameKey("pair"), new IOrType<IKey, IError>[] { OrType.Make<IKey, IError>(new NameKey("chicken")) })), true, new WeakMemberDefinitionConverter(false, new NameKey("x")));
        ...
        public void GenericContainsSelf()
        {
            ...
            })), true, new WeakMemberDefinitionConverter(false, new NameKey("next")));
            ...
            })), true, new WeakMemberDefinitionConverter(false, new NameKey("thing")));
        ...
        public void GenericCircular()
        {
            ...
            var leftMember = x.CreateMember(x.ModuleRoot, new NameKey("left-member"),  OrType.Make<IKey, IError>(new GenericNameKey(new NameKey("left"), new IOrType<IKey, IError>[] { OrType.Make<IKey, IError>(new NameKey("chicken")) })), true, new WeakMemberDefinitionConverter(false, new NameKey("left-member")));

            var rightMember = x.CreateMember(x.ModuleRoot, new NameKey("right-member"),  OrType.Make<IKey, IError>(new GenericNameKey(new NameKey("right"), new IOrType<IKey, IError>[] { OrType.Make<IKey, IError>(new NameKey("chicken")) })), true, new WeakMemberDefinitionConverter(false, new NameKey("right-member")));
        ...
        public void NestedGeneric()
        {
            ...
            var xMember = x.CreateMember(x.ModuleRoot, new NameKey("x"),  OrType.Make<IKey, IError>(new GenericNameKey(new NameKey("pair"), new IOrType<IKey, IError>[] { OrType.Make<IKey, IError>(new GenericNameKey(new NameKey("pair"), new IOrType<IKey, IError>[] { OrType.Make<IKey, IError>(new NameKey("chicken")) })) })), true, new WeakMemberDefinitionConverter(false, new NameKey("x")));
