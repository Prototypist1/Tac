...
namespace Tac.Frontend.New.CrzayNamespace
{
    ...
    internal partial class Tpn
    {
        ...
        internal interface ISetUpTypeProblem
        {
            ...
            TypeProblem2.Member CreateMemberPossiblyOnParent(IStaticScope scope, IHavePossibleMembers havePossibleMembers, IKey key, IConvertTo<OuterFlowNode2, WeakMemberDefinition> converter);
            ...
            TypeProblem2.Method CreateMethod(IStaticScope parent, string inputName, IConvertTo<TypeProblem2.Method, IOrType<WeakMethodDefinition, WeakImplementationDefinition>> converter, IConvertTo<OuterFlowNode2, WeakMemberDefinition> inputConverter);
            TypeProblem2.Method CreateMethod(IStaticScope parent, IOrType<TypeProblem2.TypeReference, IError> inputType, IOrType<TypeProblem2.TypeReference, IError> outputType, string inputName, IConvertTo<TypeProblem2.Method, IOrType<WeakMethodDefinition, WeakImplementationDefinition>> converter, IConvertTo<OuterFlowNode2, WeakMemberDefinition> inputConverter);
            TypeProblem2.TransientMember GetReturns(IValue s);
            TypeProblem2.TransientMember GetReturns(IStaticScope s);
            TypeProblem2.Member CreateHopefulMember(IValue scope, IKey key, IConvertTo<OuterFlowNode2, WeakMemberDefinition> converter);
            ...
            TypeProblem2.Method IsMethod(IScope parent, ICanAssignFromMe target, IConvertTo<TypeProblem2.Method, IOrType<WeakMethodDefinition, WeakImplementationDefinition>> converter, IConvertTo<OuterFlowNode2, WeakMemberDefinition> inputConverter);
