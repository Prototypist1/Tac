...
namespace Tac.Semantic_Model
{
    internal class MemberMaker : IMaker<ISetUp<WeakMemberReference, LocalTpn.TypeProblem2.Member>>
    {
        ...
        private class MemberResolveReferance : IResolve<WeakMemberReference>
        {
            ...
            public MemberResolveReferance(Tpn<WeakBlockDefinition, WeakTypeDefinition, WeakObjectDefinition, WeakTypeOrOperation, WeakMethodDefinition, PlaceholderValue, WeakMemberDefinition, WeakTypeReference,WeakGenericTypeDefinition>.TypeProblem2.Member member)
            {
